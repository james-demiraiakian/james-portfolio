...
const quoteArray = [
  ...
  - Spencer Eagleton`,
  `"My experience at Alchemy Code Lab would not be the same with out James, as a cohort colleague and as a coworker. James works well with others and often brightens the room with good humor and friendly conversation. He has continuously demonstrated a strong ability to communicate coding concepts and plans, both in efforts to build full stack web apps with different teams as well as in assisting and supporting students in their JavaScript learning experience."
  - Forest Heims`,
  `"James truly shines when helping others, his ability to dive into someone elses code and debug with them makes him a great team member. He demonstrates a great ability to verbalize the problem and explain bugs thoroughly."
  -Bailey Kuebelbeck`,
];
